...
public class Main {
    ...
    private static void exercise1() {
        ...
        int ourNumberInt = Integer.valueOf(ourNumberStr) + 2;
        String ourNumberStr2 = String.valueOf(ourNumberInt);
    ...
    private static void exercise4() {
        ...
        int startInt = Integer.valueOf(startStr.trim()) * 2;
        System.out.println(startInt);

        String secondStr = String.valueOf(startInt);
        String thirdStr = secondStr + secondStr;
        System.out.println(thirdStr);

        double startDouble = (Double.valueOf(thirdStr) / 3.5);
        int finalInt = (int) Math.floor(startDouble);
