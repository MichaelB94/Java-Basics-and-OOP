...
public class Main {
     ...
     * A1: do while because the user will do at least one action
     *
     ...
     * A3: while because he can easily run the first 80 element
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4: do while because he can check the conditions before strating the loop.
     */
}
